"""
    ...
    (3) creation of an InputInfo object. If you are not familiar with object oriented
    programming, an "object" makes it easy to bundle many variables and functions together.
    Here, an InputInfo object is created, and all of the folder names are passed
...
# in this first line, we initialize the InputInfo object by passing in the
...
# the following lines are optional. By default, InputInfo specifies these values,
