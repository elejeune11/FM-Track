...
def get_filenames_cell():
	filenames_cell = [ \
		'data/Magnet/Magnetic Bead/Magnet%s.tif',\
		'data/No Magnet/Magnetic Bead/No Magnet%s.tif',\
		'data/No Magnet 2/Magnetic Bead/No Magnet 2%s.tif']
	dirnames_cell = [ \
		'data/Magnet/Magnetic Bead/',\
		'data/No Magnet/Magnetic Bead/',\
		'data/No Magnet 2/Magnetic Bead/']
	return filenames_cell, dirnames_cell 
	
def get_filenames_beads():
	filenames_beads = [ \
		'data/Magnet/Tracking Beads/Magnet%s.tif',\
		'data/No Magnet/Tracking Beads/No Magnet%s.tif',\
		'data/No Magnet 2/Tracking Beads/No Magnet 2%s.tif']
	dirnames_beads = [ \
		'data/Magnet/Tracking Beads/',\
		'data/No Magnet/Tracking Beads/',\
		'data/No Magnet 2/Tracking Beads/']
