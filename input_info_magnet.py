...
def get_filenames_cell():
	filenames_cell = [ \
		'7_16_Magnet/Magnet/Magnetic Bead/Magnet%s.tif',\
		'7_16_Magnet/No Magnet/Magnetic Bead/No Magnet%s.tif',\
		'7_16_Magnet/No Magnet 2/Magnetic Bead/No Magnet 2%s.tif']
	dirnames_cell = [ \
		'7_16_Magnet/Magnet/Magnetic Bead/',\
		'7_16_Magnet/No Magnet/Magnetic Bead/',\
		'7_16_Magnet/No Magnet 2/Magnetic Bead/']
	return filenames_cell, dirnames_cell 
	
def get_filenames_beads():
	filenames_beads = [ \
		'7_16_Magnet/Magnet/Tracking Beads/Magnet%s.tif',\
		'7_16_Magnet/No Magnet/Tracking Beads/No Magnet%s.tif',\
		'7_16_Magnet/No Magnet 2/Tracking Beads/No Magnet 2%s.tif']
	dirnames_beads = [ \
		'7_16_Magnet/Magnet/Tracking Beads/',\
		'7_16_Magnet/No Magnet/Tracking Beads/',\
		'7_16_Magnet/No Magnet 2/Tracking Beads/']
...
def get_tracking_pairs():
	...
	tracking_pairs = [ \
		['7_16_Magnet','7_16_NoMagnet'],\
		['7_16_NoMagnet','7_16_NoMagnet2'],\
		['7_16_Magnet','7_16_NoMagnet2']]
